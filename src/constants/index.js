...
const services = [
  {
    title: "Automation Engineer for embedded C",
    icon: web,
  },
  {
    title: "Selenium",
...
//   {
//     name: "Appium",
//     icon: "https://upload.wikimedia.org/wikipedia/commons/6/6a/Appium_Logo.png",
//   },
//   {
//     name: "Docker",
...
const experiences = [
    ...
    date: "2025 - 2026",
    points: [
      "Developed and executed automated tests in C for an autonomous vehicle LiDAR system.",
      "Designed test scenarios and performed white-box testing alongside the codebase, with thorough documentation in CodeBeamer.",
      "Conducted integration testing based on architectural requirements and in-depth feature analysis.",
      "Worked with Jira, Jenkins, and GitLab as part of CI/CD pipeline implementation and version control.",
      "Followed ASPICE standards."
    ],
  },
  {
